...
{
	assert(array);//Saber si array tiene algo
...
{
	size_t new_capacity = 10 * array->array_elements;
	void** new_elements = (void**)realloc( array->array_capacity, new_capacity * sizeof(void*) );
